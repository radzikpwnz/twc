...
static void PropOnSetCustomAction_Common( TWC_OBJECT *obj, UINT prop_id)
{
    switch ( prop_id ) {
        case COMMON_NAME:
...
static void PropCodegenCustomAction_Common( TWC_OBJECT *obj, UINT prop_id, TCHAR **style, TCHAR **exstyle)
{
    VALUE *val;
...
void PropOnSetCustomAction_Window( TWC_OBJECT *obj, UINT prop_id)
{
    VALUE *val;
    RECT rect;
...
static void PropOnSetCustomAction_Button( TWC_OBJECT *obj, UINT prop_id)
{
    VALUE *val;
...
static void PropCodegenCustomAction_Button( TWC_OBJECT *obj, UINT prop_id, TCHAR **style, TCHAR **exstyle)
{
    VALUE *val;
