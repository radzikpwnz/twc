 ...
 */
static int ParsePropertyVal( TWC_OBJECT *obj, /* object */
 ...
 * Parse object.
 */
static int ParseObject( TWC_OBJECT *parent) /* parent object */
{
    LEX lex;
    TWC_OBJECT *obj;

    /* Create and prepare object */
    obj = twc_NewObject( cur_obj_id);
 ...
 * Parse buffer.
 */
static int Parse( TWC_OBJECT *root_obj, /* root object */
                 TCHAR *buf)           /* buffer */
{
	LEX lex;
